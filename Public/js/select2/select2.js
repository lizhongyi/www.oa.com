...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        opening: function() {
			...
			var $sid=$("#"+this.container.attr('id').substr(5,10));
			
			
			if($sid.attr('link') && $sid.attr('zt')!=1 ){
		    $sid.load($sid.attr('link'));
			$sid.attr('zt',1);
			}
    ...
    $.fn.select2.defaults = {
        ...
        formatNoMatches: function () { return "没有找到匹配的结果"; },
        formatInputTooShort: function (input, min) { return "请输入 " + (min - input.length) + " more characters"; },
        formatSelectionTooBig: function (limit) { return "你只能选择 " + limit + " item" + (limit == 1 ? "" : "s"); },
