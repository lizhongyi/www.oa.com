...
删除顶级级分类将会自动删除此分类下的子分类。<br />
  ...
  <form id="form1" name="form1" method="post" action="__APP__/Site/area_all_save">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" id="list" class="link_lan"  >
    ...
    <tr>
      ...
      <td class="admin_list" style="text-align:center;">
			  ...
			  <a onClick="return confirm('你确定要删除吗？')" href="__APP__/Site/area_del?id=<?php echo ($list["id"]); ?>">删除</a>
			...
			<!--小类 -->
			 ...
			 <img src="__PUBLIC__/skin/images/cat_left1.gif" border="0" align="absmiddle" />
			  ...
			  <a onClick="return confirm('你确定要删除吗？')" href="__APP__/Site/area_del?id=<?php echo ($subs["id"]); ?>">删除</a>
